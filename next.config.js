        ...
        headers: [
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline'; worker-src 'self' blob:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https: blob:; font-src 'self' data: https://fonts.gstatic.com; media-src 'self' https://*.r2.dev https://*.r2.cloudflarestorage.com https://raw.githubusercontent.com; connect-src 'self' blob: https://*.thirdweb.com wss://*.thirdweb.com https://*.r2.cloudflarestorage.com https://*.r2.dev https://assets.numinia.store https://assets.opensourceavatars.com https://*.ipfs.io https://dweb.link https://*.dweb.link https://gateway.pinata.cloud https://*.arweave.net https://arweave.net https://raw.githubusercontent.com https://api.github.com https://*.githubusercontent.com https://www.gstatic.com; frame-src 'self' https://*.thirdweb.com https://accounts.google.com https://discord.com https://github.com https://x.com; frame-ancestors 'self';"
          },
