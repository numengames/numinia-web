          ...
          {!isMobile && (
            <div className="flex items-center gap-28">
              ...
              <div className="flex items-center gap-4">
                <a href="/" target="_blank" rel="noopener noreferrer" aria-label="Numinia">
                ...
                <a href="https://github.com/PabloFMM/numinia-digital-goods" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
