  ...
  home: {
    en: {
      ...
      openGraph: {
        ...
        type: 'website',
        images: [{ url: SITE_URL + '/opengraph-image.png', width: 1200, height: 630, alt: 'Numinia Open Source 3D Assets' }],
      },
      twitter: {
    ...
    ja: {
      ...
      openGraph: {
        ...
        type: 'website',
        locale: 'ja_JP',
        images: [{ url: SITE_URL + '/opengraph-image.png', width: 1200, height: 630, alt: 'Numinia Open Source 3D Assets - 無料GLB 3Dアセット' }],
      },
      twitter: {
        card: 'summary_large_image',
        title: 'Numinia Open Source 3D Assets - 無料GLB 3Dアセット',
    ...
    es: {
      ...
      openGraph: {
        ...
        type: 'website',
        locale: 'es_ES',
        images: [{ url: SITE_URL + '/opengraph-image.png', width: 1200, height: 630, alt: 'Numinia Digital Goods - Activos 3D CC0 Gratis' }],
      },
      twitter: {
        card: 'summary_large_image',
        title: 'Numinia Digital Goods - Activos 3D CC0 Gratis',
