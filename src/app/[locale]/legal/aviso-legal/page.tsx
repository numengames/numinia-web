      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <article className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <p>
            ...
            <a href={`/${locale}/legal/terms`}>T&eacute;rminos y Condiciones</a>.
          </p>
          ...
          <p>
            ...
            <a href={`/${locale}/legal/privacy`}>Pol&iacute;tica de Privacidad</a> para informaci&oacute;n
          ...
          <p>
            ...
            <a href={`/${locale}/legal/cookies`}>Pol&iacute;tica de Cookies</a>.
          </p>
