  ...
  return (
    <div className="flex min-h-screen bg-cream dark:bg-cream-dark">
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        {activeView === 'portals' && (
          <div className="max-w-3xl mx-auto p-6">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Portals</h1>
            <p className="text-sm text-gray-500 mb-6">Hyperfy worlds and interactive experiences.</p>
    ...
    <div className="max-w-2xl mx-auto p-6">
      ...
      <section className="my-8">
        ...
        <div className="space-y-2 text-sm text-gray-500">
          <div className="flex justify-between"><span>Version</span><span className="text-gray-900 dark:text-white">0.10.0</span></div>
