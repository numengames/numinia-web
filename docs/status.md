...
| #   | What                                                                                                                                                                                                                                                              | Owner                     | Notes                                                                                                      |
| --- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------- | ---------------------------------------------------------------------------------------------------------- |
| 1   | **Design system — prepare, then execute**: Oracle delivers the design .md into the repo → translate into `packages/ui` tokens + primitives inventory + audit every existing surface against it → apply progressively (MISSION-006 to spec on doc arrival)         | 🧬 doc, 🤖 execution      | THE priority: the rest of the platform gets rebuilt wearing it                                             |
