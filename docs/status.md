...
| 11  | **MISSION-030 — numinia.store SEO migration** (301 → numinia.com + Search Console change of address + legacy Vercel shutdown + SIWE `AUTH_DOMAIN` fix): parked by Oracle order 2026-08-16; the .store renewal date is the clock                                                                                                                                                                                                                                                                     | 🧬 domain/GSC, 🤖 code | Specced in missions/MISSION-030; two live sites split search signals meanwhile |
