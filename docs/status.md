...
| 3b  | **MISSION-003 web parity** (Oracle directive 2026-08-15): rebuild the original public surface — P1 gallery, P2 finder, P3 updates+legal, P4 docs, P5 inspectors. Spec in `missions/MISSION-003-web-parity.md` | 🧬 approves plan, 🤖 executes | Layer 0–1 only; LAP/login stay in MISSION-002+                       |
