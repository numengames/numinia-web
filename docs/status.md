...
| 4   | **Write-path ADR** — how the platform writes. **Dossier ready: docs/adr-write-path-dossier.md** (option map A-D, recommendation, D19-D23). Unblocks: banning/promoting users, asset upload/edit, sheet sync, Session Zero recording | 🧬 decision (session)     | The single biggest unlock for the game half of the platform                  |
