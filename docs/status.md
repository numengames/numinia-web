...
| --- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- | ------------------------------------------------------------------------------ |
| 1   | **Key-rotation audit** (inherited CLOUDFLARE_API_TOKEN repo secrets, thirdweb, R2, ~21 stale legacy Vercel vars) + decommission                                                                                                                                                                                                                                                                                                                                                                     | 🧬🤖                   | The deploys run on an inherited token — the standing risk                      |
